...
Original file is located at
    https://colab.research.google.com/drive/1dnri7jNoWoaKXI_QqgJEQzp10EPeVYUR
"""
...
# 1. Define a resnet50 model
resnet50 = models.resnet50(pretrained=True)

# แก้ Fully Connected Layer สุดท้าย
#  2. Modify the fc (fully connected) layer
...
# 3. Reinitialize the criterion and optimizer
...
num_epochs = 50
print("Starting training for resnet50 with Dropout and Early Stopping...")
...
for epoch in range(num_epochs):
    ...
    if valid_loss < best_valid_loss:
        ...
        best_model_state = copy.deepcopy(resnet50.load_state_dict(torch.load("best_model.pth")))
        patience_counter = 0
...
# 6. Load the best model state after training (or early stopping)
...
# ==========================
# 6️⃣ Plotting Overfit Graph for resnet50 (กราฟ Overfit)
# ==========================
...
ax[0].set_title("Training vs Validation Loss (with Dropout & Early Stopping)")
ax[0].legend()
...
ax[1].set_title("Training vs Validation Accuracy (with Dropout & Early Stopping)")
ax[1].legend()
...
# ==========================
# 8️⃣ Confusion Matrix (Validation Data) for resnet50
# ==========================
...
accuracy_valid = accuracy_score(all_labels_valid, all_preds_valid)
precision_valid = precision_score(all_labels_valid, all_preds_valid, average='weighted', zero_division=0)
recall_valid = recall_score(all_labels_valid, all_preds_valid, average='weighted', zero_division=0)
f1_valid = f1_score(all_labels_valid, all_preds_valid, average='weighted', zero_division=0)
...
# ==========================
# 9️⃣ Confusion Matrix (Train Data) for resnet50
# ==========================
...
# สร้าง Confusion Matrix
cm = confusion_matrix(all_labels_train, all_pred_train)

print("Confusion Matrix:")
print(cm)

# Calculate and print additional metrics
accuracy_train = accuracy_score(all_labels_train, all_pred_train)
precision_train = precision_score(all_labels_train, all_pred_train, average='weighted', zero_division=0)
recall_train = recall_score(all_labels_train, all_pred_train, average='weighted', zero_division=0)
f1_train = f1_score(all_labels_train, all_pred_train, average='weighted', zero_division=0)
...
# บันทึกโมเดลเมื่อได้ผลลัพธ์ดีที่สุด (Best Model)
best_acc = 0.0
